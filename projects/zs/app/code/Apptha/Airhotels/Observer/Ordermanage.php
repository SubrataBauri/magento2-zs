...
class Ordermanage implements ObserverInterface
{
     ...
     */
    public function __construct(Data $airhotelsData, \Magento\Checkout\Model\Session $checkoutSession, OrderIdentity $identityContainer, Renderer $addressRenderer, PaymentHelper $paymentHelper)
    {
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        foreach ($orderItems as $item) {
            ...
            $from = $objDate->date('Y-m-d', $productOptions['info_buyRequest']['from']);
            $to = $objDate->date('Y-m-d', $productOptions['info_buyRequest']['to']);
    ...
    public function sendOrderEmailToHost($hostOrder, $order, $product){
      ...
      $currencyHelper=$objectManager->get ('Apptha\Airhotels\Helper\Order' )->getCurrencySymbol();
        ...
        $emailTempVariables = (array (
                ...
                'owner_amount'=>$currencyHelper.$ownerAmount,
